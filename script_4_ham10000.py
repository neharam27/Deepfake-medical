"""
script_4_ham10000.py
Leakage-free deepfake detection pipeline for HAM10000 dataset.
...
Dataset: Human Against Machine with 10000 training images (HAM10000)
  ...
  Images: two parts — HAM10000_images_part_1/ and HAM10000_images_part_2/ (JPEG)
  Metadata: HAM10000_metadata.csv (image_id, dx, dx_type, age, sex, localization)

Expected layout:
  DATA_PATH/
    HAM10000_images_part_1/   (*.jpg)
    HAM10000_images_part_2/   (*.jpg)
    HAM10000_metadata.csv     (optional)

Before running, set DATA_PATH to the root of your HAM10000 download.
"""
...
# USER CONFIGURATION
# ============================================================
DATA_PATH  = os.environ.get("HAM10000_PATH", "./ham10000_data")
OUTPUT_DIR = "."
WORK_DIR   = "./work_ham10000"
...
# ============================================================
# STEP 0 – Collect HAM10000 images & split 60/20/20
# ============================================================
print("=" * 70)
print("STEP 0: DATA LOADING & SPLITTING (HAM10000)")
print("=" * 70)

def collect_ham10000_images(data_path):
    """Collect JPEG images from HAM10000_images_part_1/ and part_2/, or any sub-folder."""
    paths = []
...
all_paths = collect_ham10000_images(DATA_PATH)
if len(all_paths) == 0:
    sys.exit(
        f"[ERROR] No images found under DATA_PATH='{DATA_PATH}'.\n"
        "Set DATA_PATH to the HAM10000 dataset root."
    )
...
def copy_and_resize(paths, dest_dir, img_size, desc):
    ...
    for i, p in enumerate(tqdm(paths, desc=desc)):
        # HAM10000 images are RGB — convert to grayscale
