"""
script_5_isic.py
Leakage-free deepfake detection pipeline for the ISIC Archive dataset.

Dataset: ISIC Archive (skin lesion dermoscopy images)
  URL: https://www.isic-archive.com  or  https://challenge.isic-archive.com
  Images: JPEG files (any ISIC challenge year: 2016-2020)

Expected layout (any of the following structures work):
  DATA_PATH/
    ISIC_0024306.jpg      (flat folder)
  OR
  DATA_PATH/
    train/
      *.jpg
    test/
      *.jpg
  OR any nested structure – the script walks the whole tree.

Before running, set DATA_PATH to the root of your ISIC download.
"""
...
# USER CONFIGURATION
# ============================================================
DATA_PATH  = os.environ.get("ISIC_PATH", "./isic_data")
OUTPUT_DIR = "."
WORK_DIR   = "./work_isic"
...
# ============================================================
# STEP 0 – Collect ISIC images & split 60/20/20
# ============================================================
print("=" * 70)
print("STEP 0: DATA LOADING & SPLITTING (ISIC Archive)")
print("=" * 70)

def collect_isic_images(data_path):
    """Walk data_path and collect all .jpg / .jpeg / .png image files."""
    paths = []
...
all_paths = collect_isic_images(DATA_PATH)
if len(all_paths) == 0:
    sys.exit(
        f"[ERROR] No images found under DATA_PATH='{DATA_PATH}'.\n"
        "Set DATA_PATH to your ISIC dataset root."
    )
...
def copy_and_resize(paths, dest_dir, img_size, desc):
    """Read RGB dermoscopy image → grayscale → resize → save as PNG."""
